...
<TablaFiltrableComponentes
  tabla={ofertas.filter(ofer => ofer.titulacion.includes('GRE') && ofer.plazas_disponibles > 0 && ofer.periodo_academico === acuerdo.periodo_academico && (asignada(asignaturas, ofer) === null || asignada(asignaturas, ofer) === undefined))}
  {acuerdo}
